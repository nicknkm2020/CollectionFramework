package TreeSetExampleTreeSetAlphabetExample;
public class Employeee implements Comparable<Object>
{
    ...
    {
        return "Employeee [name=" + name + ", age=" + age + ", salary=" + salary
                + "]";
    }
    ...
    public int compareTo(Object object)
    {
    	...
    	Employeee employee = (Employeee) object;

        System.out
                .print("CompareTo method has been called to arrange the employee objects in ascending order based on the Age, ");
